...
func (_ERC20 *ERC20Transactor) SetBlacklist(opts *bind.TransactOpts, blacklist_ common.Address) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "setBlacklist", blacklist_)
}

// SetBlacklist is a paid mutator transaction binding the contract method 0x4e054a67.
//
// Solidity: function setBlacklist(address blacklist_) returns()
func (_ERC20 *ERC20Session) SetBlacklist(blacklist_ common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.SetBlacklist(&_ERC20.TransactOpts, blacklist_)
}

// SetBlacklist is a paid mutator transaction binding the contract method 0x4e054a67.
//
// Solidity: function setBlacklist(address blacklist_) returns()
func (_ERC20 *ERC20TransactorSession) SetBlacklist(blacklist_ common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.SetBlacklist(&_ERC20.TransactOpts, blacklist_)
}
...
func (_ERC20 *ERC20Transactor) SetBlacklistState(opts *bind.TransactOpts, state bool) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "setBlacklistState", state)
}

// SetBlacklistState is a paid mutator transaction binding the contract method 0xfdb1954a.
//
// Solidity: function setBlacklistState(bool state) returns()
func (_ERC20 *ERC20Session) SetBlacklistState(state bool) (*types.Transaction, error) {
	return _ERC20.Contract.SetBlacklistState(&_ERC20.TransactOpts, state)
}

// SetBlacklistState is a paid mutator transaction binding the contract method 0xfdb1954a.
//
// Solidity: function setBlacklistState(bool state) returns()
func (_ERC20 *ERC20TransactorSession) SetBlacklistState(state bool) (*types.Transaction, error) {
	return _ERC20.Contract.SetBlacklistState(&_ERC20.TransactOpts, state)
}
...
// ERC20BlacklistChangedIterator is returned from FilterBlacklistChanged and is used to iterate over the raw logs and unpacked data for BlacklistChanged events raised by the ERC20 contract.
type ERC20BlacklistChangedIterator struct {
	Event *ERC20BlacklistChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20BlacklistChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20BlacklistChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20BlacklistChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20BlacklistChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20BlacklistChanged represents a BlacklistChanged event raised by the ERC20 contract.
type ERC20BlacklistChanged struct {
...
func (_ERC20 *ERC20Filterer) FilterBlacklistChanged(opts *bind.FilterOpts, oldBlacklist []common.Address, newBlacklist []common.Address) (*ERC20BlacklistChangedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "BlacklistChanged", oldBlacklistRule, newBlacklistRule)
	if err != nil {
		return nil, err
	}
	return &ERC20BlacklistChangedIterator{contract: _ERC20.contract, event: "BlacklistChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BlacklistChanged(address indexed oldBlacklist, address indexed newBlacklist)
func (_ERC20 *ERC20Filterer) WatchBlacklistChanged(opts *bind.WatchOpts, sink chan<- *ERC20BlacklistChanged, oldBlacklist []common.Address, newBlacklist []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "BlacklistChanged", oldBlacklistRule, newBlacklistRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20BlacklistChanged)
				if err := _ERC20.contract.UnpackLog(event, "BlacklistChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BlacklistChanged(address indexed oldBlacklist, address indexed newBlacklist)
func (_ERC20 *ERC20Filterer) ParseBlacklistChanged(log types.Log) (*ERC20BlacklistChanged, error) {
	event := new(ERC20BlacklistChanged)
	if err := _ERC20.contract.UnpackLog(event, "BlacklistChanged", log); err != nil {
		return nil, err
	}
...
// ERC20BlacklistStatusChangedIterator is returned from FilterBlacklistStatusChanged and is used to iterate over the raw logs and unpacked data for BlacklistStatusChanged events raised by the ERC20 contract.
type ERC20BlacklistStatusChangedIterator struct {
	Event *ERC20BlacklistStatusChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20BlacklistStatusChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20BlacklistStatusChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20BlacklistStatusChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20BlacklistStatusChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20BlacklistStatusChanged represents a BlacklistStatusChanged event raised by the ERC20 contract.
type ERC20BlacklistStatusChanged struct {
	NewStatus bool
	Raw       types.Log // Blockchain specific contextual infos
}
...
func (_ERC20 *ERC20Filterer) FilterBlacklistStatusChanged(opts *bind.FilterOpts, newStatus []bool) (*ERC20BlacklistStatusChangedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "BlacklistStatusChanged", newStatusRule)
	if err != nil {
		return nil, err
	}
	return &ERC20BlacklistStatusChangedIterator{contract: _ERC20.contract, event: "BlacklistStatusChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BlacklistStatusChanged(bool indexed newStatus)
func (_ERC20 *ERC20Filterer) WatchBlacklistStatusChanged(opts *bind.WatchOpts, sink chan<- *ERC20BlacklistStatusChanged, newStatus []bool) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "BlacklistStatusChanged", newStatusRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20BlacklistStatusChanged)
				if err := _ERC20.contract.UnpackLog(event, "BlacklistStatusChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BlacklistStatusChanged(bool indexed newStatus)
func (_ERC20 *ERC20Filterer) ParseBlacklistStatusChanged(log types.Log) (*ERC20BlacklistStatusChanged, error) {
	event := new(ERC20BlacklistStatusChanged)
	if err := _ERC20.contract.UnpackLog(event, "BlacklistStatusChanged", log); err != nil {
		return nil, err
	}
